...
const previews = {
  ...
  pdf: `<span style="color:var(--text3)">[PDF Preview]<br>━━━━━━━━━━━━━━━━━━━━━<br>  snapdfy Data Report<br>  Generated: ${new Date().toLocaleDateString()}<br>━━━━━━━━━━━━━━━━━━━━━<br>  EXECUTIVE SUMMARY<br>  ...</span>`,
...
function getFilename(res, fmt) {
  ...
  return snapdfy`_export${exts[fmt] || ""}`;
}
